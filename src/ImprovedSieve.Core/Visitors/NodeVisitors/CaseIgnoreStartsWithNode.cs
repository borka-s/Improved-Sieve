...
{
    public class CaseIgnoreStartsWithNode : TwoChildNode
    {
        public override Expression Visit(Expression leftExpression, Expression rightExpression)
        {
            ...
            return Expression.Call(leftExpression, Constants.ExpressionMethods.StartsWith, null, rightExpression, comparisonType);
        }
    }
}